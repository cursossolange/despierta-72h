...
<p className="text-[18px] md:text-[1.4rem] text-slate-700 font-medium mb-5 text-center max-w-3xl mx-auto leading-relaxed">
 Una experiencia guiada de 3 días para dejar de reaccionar desde el cansancio, el ruido mental y el modo automático. 
</p>
</div>
...
Porque seguir funcionando así no solo te agota.
También tiene un costo en cómo reaccionas, cómo te relacionas y cómo te sientes contigo misma.
</p>
    </div>
</div>
