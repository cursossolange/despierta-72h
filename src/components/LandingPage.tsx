...
const CTAButton = ({
  ...
  <a
    ...
    className={`bg-[#E8590C] text-white rounded-xl font-black hover:bg-[#C2410C] shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all inline-flex items-center justify-center gap-2 ${
      size === "lg"
...
export default function LandingPage({ onPurchase }: LandingPageProps) {
  return (
    <div className="min-h-screen bg-white font-sans leading-normal" style={{ color: '#2B2420' }}>
      {/* ── BARRA ── */}
      <div className="bg-[#E8590C] text-white text-center py-2.5 px-4">
        <p className="text-xs md:text-sm font-semibold tracking-wide">
          ✦ Comienza en Octubre · Cupos limitados
        </p>
      </div>
      {/* ── HERO ── */}
      <header className="bg-white pt-12 pb-0">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <motion.p
            ...
            className="text-[#E8590C] tracking-[0.4em] text-2xl md:text-3xl font-black uppercase mb-6"
          >
            Despierta
          </motion.p>
          <motion.h1
          ...
          <motion.h2
            ...
            className="text-[1.6rem] md:text-[2.4rem] font-black tracking-tight leading-[1.1] mb-6 text-[#E8590C]"
          >
            Y estás cansada.
          </motion.h2>
          <motion.p
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-3 bg-[#E8590C] text-white rounded-2xl px-6 py-3 mb-6"
          >
            <Calendar className="w-5 h-5 shrink-0" />
            <div className="text-left">
              <p className="font-black text-base md:text-lg leading-none">Comienza en Octubre</p>
          ...
          <motion.div
            ...
            className="bg-[#FDF3D9] rounded-2xl p-4 md:p-5 mb-8 max-w-xl mx-auto"
          >
            <p className="text-sm md:text-base font-semibold" style={{ color: '#46403A' }}>
          ...
          >
            ...
            <p className="text-sm" style={{ color: '#8A8074' }}>
      ...
      {/* ── COSTO DE INACCIÓN ── */}
      <section className="py-12 bg-[#2B2420] text-white">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <h2 className="text-2xl md:text-3xl font-black leading-tight mb-10" style={{ color: '#2B2420' }}>
          ...
          <div className="space-y-3 text-left max-w-lg mx-auto">
            {[
              ...
              <div key={i} className="flex items-start gap-3 rounded-xl px-4 py-3 border border-[#F0DFB0] bg-[#FFF3D6]">
                <span className="text-[#E8590C] font-black mt-0.5 shrink-0">✦</span>
                <p className="text-sm md:text-base leading-relaxed" style={{ color: '#46403A' }}>{item}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── EL RESULTADO ── */}
      <section className="py-12 bg-[#FDF3D9]">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-10">
            <p className="font-black text-xl md:text-2xl mb-3" style={{ color: '#2B2420' }}>
              Antes de cambiar algo, necesitas verlo.
            </p>
            <p className="text-sm md:text-base leading-relaxed max-w-xl mx-auto mb-8" style={{ color: '#6B6259' }}>
            ...
            <p className="text-[#E8590C] text-sm font-black uppercase tracking-widest mb-3">El resultado</p>
            <h2 className="text-3xl md:text-5xl font-black leading-tight mb-4" style={{ color: '#2B2420' }}>
              Tus 3 comportamientos automáticos<br className="hidden md:block" /> con mayor impacto hoy.
            </h2>
            <p className="text-base md:text-lg leading-relaxed max-w-xl mx-auto mb-2" style={{ color: '#57504A' }}>
            ...
            <p className="text-sm md:text-base max-w-lg mx-auto" style={{ color: '#7C7266' }}>
              Porque no todo necesita cambiar. Aprenderás a reconocer dónde vale la pena empezar.
            </p>
          </div>
          {/* MAPA */}
          <div className="bg-white rounded-2xl p-6 md:p-8 border-2 border-[#E8590C]/20 shadow-sm max-w-2xl mx-auto">
            <div className="flex items-start gap-3 mb-4">
              <span className="text-2xl">📍</span>
              <div>
                <p className="text-[#E8590C] text-xs font-black uppercase tracking-widest mb-1">Además construirás tu</p>
                <p className="font-black text-lg md:text-xl" style={{ color: '#2B2420' }}>Mapa de Automatismos e Impactos</p>
              </div>
            </div>
            <p className="text-sm md:text-base leading-relaxed mb-4" style={{ color: '#57504A' }}>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-start gap-2">
                  <span className="text-[#E8590C] shrink-0 mt-0.5">✦</span>
                  <p className="text-sm leading-relaxed" style={{ color: '#57504A' }}>{item}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-12 bg-[#FDF3D9]">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h2 className="text-2xl md:text-4xl font-black leading-tight mb-4" style={{ color: '#2B2420' }}>
            Despierta no es un curso.<br />Es una experiencia de observación guiada.
          </h2>
          <p className="text-base md:text-lg leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: '#57504A' }}>
          ...
          <div className="grid md:grid-cols-3 gap-4 text-left mb-8">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
                <p className="text-[#E8590C] font-black text-3xl mb-1">{card.num}</p>
                <p className="text-xs font-black uppercase tracking-widest mb-2" style={{ color: '#93897B' }}>{card.semana}</p>
                <h4 className="font-black text-lg leading-tight mb-2" style={{ color: '#2B2420' }}>{card.title}</h4>
                <p className="text-sm leading-relaxed" style={{ color: '#6B6259' }}>{card.desc}</p>
              </div>
            ))}
          </div>
          {/* TIEMPO REQUERIDO */}
          <div className="bg-white rounded-2xl p-5 border border-[#F5D9A0] flex flex-col md:flex-row items-center justify-center gap-6 max-w-2xl mx-auto">
            <Clock className="w-8 h-8 text-[#E8590C] shrink-0" />
            <div className="text-left">
              <p className="font-black text-sm md:text-base mb-1" style={{ color: '#2B2420' }}>¿Cuánto tiempo necesitas dedicarle?</p>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6 max-w-3xl">
          <p className="text-[#E8590C] text-xs font-black uppercase tracking-widest mb-8 text-center"> Tu inscripción incluye</p>
          <div className="space-y-3">
            {[
              { title: "3 sesiones grupales en vivo", benefit: "Para acompañarte paso a paso durante todo el proceso.", extra: "Fechas exactas de octubre se confirman al inscribirte — martes a las 19:00 hrs (Chile). Si no puedes asistir, todas las sesiones quedarán grabadas." },
              ...
              <div key={i} className="flex items-start gap-4 rounded-xl px-4 py-4 border border-slate-100">
                <span className="text-[#E8590C] font-black shrink-0 mt-0.5">✦</span>
                <div>
                  <p className="font-black text-sm md:text-base" style={{ color: '#2B2420' }}>{item.title}</p>
                  <p className="text-sm leading-relaxed mt-0.5" style={{ color: '#7C7266' }}>{item.benefit}</p>
                  {item.extra && <p className="text-xs leading-relaxed mt-1 text-[#E8590C] font-semibold">{item.extra}</p>}
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 bg-[#FDF3D9]">
        <div className="container mx-auto px-6 max-w-3xl">
          <div className="bg-white rounded-[2rem] border border-slate-100 p-8 md:p-12 shadow-sm">
            <p className="text-xs font-black text-[#E8590C] uppercase tracking-widest mb-6 text-center">Quién está detrás de esto</p>
            <img src="/bienvenida-solange.png" alt="Solange Henríquez" className="w-full rounded-[1.5rem] mb-6" />
            <div className="bg-[#FDF3D9] rounded-xl px-5 py-4 mb-6 text-center border border-slate-100">
              <p className="text-sm font-semibold leading-relaxed" style={{ color: '#E8590C' }}>
            ...
            <h2 className="text-2xl md:text-3xl font-semibold leading-tight text-center mb-6" style={{ color: '#2B2420' }}>Hola, soy Solange.</h2>
            <div className="text-[15px] md:text-base leading-[1.9] space-y-4" style={{ color: '#46403A' }}>
              ...
              <p className="font-semibold" style={{ color: '#2B2420' }}>¿Cuánto de lo que hacemos cada día es realmente una elección y cuánto es simplemente algo que aprendimos a hacer hace años?</p>
              ...
              <p className="font-semibold" style={{ color: '#2B2420' }}>Por eso creé Despierta. No para decirte qué hacer. Sino para ayudarte a observar con mayor claridad aquello que hoy puede estar pasando desapercibido.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6 max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-black leading-tight mb-4" style={{ color: '#2B2420' }}>
              Lo que descubrieron otras mujeres al participar en Despierta
            </h2>
            <p className="text-sm md:text-base leading-relaxed max-w-xl mx-auto" style={{ color: '#6B6259' }}>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-[#FFF3D6] rounded-2xl p-6 border border-[#F0DFB0] flex flex-col justify-between">
                <p className="text-sm md:text-base leading-relaxed mb-4 italic" style={{ color: '#46403A' }}>
                  "{t.quote}"
                </p>
                <p className="text-xs font-black uppercase tracking-widest text-[#E8590C]">
                  {t.name} · {t.age}
                </p>
              </div>
            ))}
          </div>
          <p className="text-xs text-center mt-6" style={{ color: '#93897B' }}>
      ...
      <section className="py-12 bg-white border-y border-slate-100">
        <div className="container mx-auto px-6 max-w-xl text-center">
          <h2 className="text-2xl md:text-3xl font-black mb-2" style={{ color: '#2B2420' }}>Despierta · Comienza en Octubre</h2>
          <p className="text-5xl md:text-6xl font-black text-[#E8590C] mb-1">$180.000</p>
          <p className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: '#93897B' }}>CLP</p>
          <p className="text-sm md:text-base leading-relaxed max-w-md mx-auto mb-8" style={{ color: '#6B6259' }}>
            Este es el precio de lanzamiento. El valor aumentará para futuras versiones del programa.
          </p>
          <div className="flex flex-col items-center gap-3">
            <CTAButton label="Quiero reservar mi lugar" size="lg" />
            <p className="text-sm" style={{ color: '#8A8074' }}>$180.000 CLP · Comienza en Octubre · Cupos limitados · Garantía 7 días</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-[#FDF3D9]">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="text-2xl md:text-3xl font-black text-center mb-10" style={{ color: '#2B2420' }}>Si estás pensando esto…</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-5 md:p-6 border border-slate-100 shadow-sm">
                <p className="font-black text-base md:text-lg mb-2" style={{ color: '#2B2420' }}>{item.q}</p>
                <p className="text-sm md:text-base leading-relaxed" style={{ color: '#6B6259' }}>{item.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── GARANTÍA ── */}
      <section className="py-12 bg-[#FAF3E2] border-y border-slate-100">
        <div className="container mx-auto px-6 max-w-xl text-center">
          <div className="flex justify-center mb-4">
            <ShieldCheck className="w-10 h-10 text-[#E8590C]" />
          </div>
          <h3 className="text-xl md:text-2xl font-black mb-3" style={{ color: '#2B2420' }}>Sin riesgo.</h3>
          <p className="text-sm md:text-base leading-relaxed" style={{ color: '#6B6259' }}>
      ...
      {/* ── CTA FINAL ── */}
      <section className="py-20 bg-[#FDF3D9]">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <h2 className="text-3xl md:text-5xl font-black leading-tight mb-4" style={{ color: '#2B2420' }}>
            No se trata de convertirte<br />en alguien diferente.
          </h2>
          <p className="text-xl md:text-2xl font-bold mb-6 text-[#E8590C]">
            Se trata de reconocer qué quieres seguir llevando contigo y qué ya no.
          </p>
          <p className="text-sm md:text-base mb-8 max-w-md mx-auto leading-relaxed" style={{ color: '#6B6259' }}>
          ...
          <div className="mt-6">
            <p className="text-sm mb-1" style={{ color: '#A89E8E' }}>¿Tienes dudas antes de empezar?</p>
            <a href="https://wa.me/56990991901" target="_blank" rel="noopener noreferrer" className="text-[#E8590C] font-bold text-sm hover:underline">
      ...
      <footer className="py-6 border-t border-slate-100 text-center bg-white">
        <div className="container mx-auto px-6">
          <p className="text-[#E8590C] tracking-[0.4em] text-xs font-black uppercase opacity-40 mb-1">Despierta</p>
          <p className="text-[10px] font-medium tracking-widest uppercase" style={{ color: '#B8AD9C' }}>© 2026</p>
        </div>
      </footer>
    </div>
  );
