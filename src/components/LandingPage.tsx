    ...
    <div className="min-h-screen bg-white font-sans selection:bg-violet-100 selection:text-violet-900 leading-normal">
      ...
      <header className="relative overflow-hidden pt-8 pb-6 md:pt-10 md:pb-8 bg-white">
        <div className="container mx-auto px-6 relative z-10">
          ...
          <h1 className="text-[2.2rem] md:text-[4.2rem] font-black tracking-tight text-slate-900 mt-0 mb-4 md:mb-6 leading-tight">
  <>
  SIGUES FUNCIONANDO...
  <br />
  REACCIONANDO...
  <br />
  Y DÁNDOTE CUENTA DESPUÉS QUE PODRÍAS HABER REACCIONADO DISTINTO.
</>
</h1>
